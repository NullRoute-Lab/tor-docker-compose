...
- multitor/conjure core: implement sequential retry per request, sequential retry per session, loadbalance per request, loadbalance per session based on random, sorted based on ping or download
